      ...
      <AnimatePresence>
        {showBadge && (
          <motion.div
            ...
            className="fixed top-20 left-1/2 z-[60] bg-background border border-primary/40 rounded-xl px-4 py-2.5 shadow-xl flex items-center gap-3 max-w-[calc(100vw-2rem)]"
          >
